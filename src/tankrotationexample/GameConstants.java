...
public class GameConstants {
    public static final int GAME_SCREEN_WIDTH = 1600;
    public static final int GAME_SCREEN_HEIGHT = 900;

    public static final int WORLD_WIDTH = 1632;
    public static final int WORLD_HEIGHT = 1632;
